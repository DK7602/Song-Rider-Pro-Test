...
card.appendChild(top);
    ...
    for(let i=0;i<8;i++){
      ...
      inp.addEventListener("pointerdown", (e) => {
        ...
        // Keep the keyboard closed while the user decides between
        // a normal tap-to-edit and a long-press chord copy.
        e.preventDefault();
      ...
      inp.addEventListener("pointerup", () => {
        const hadTimer = !!chordDragCopy.timer;
        clearChordCopyTimer();
        if(hadTimer && !chordDragCopy.active && inp.dataset.pendingTapFocus === "1") {
